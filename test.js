...
eql(normalize('S+U Blissestraße', {sbahnUbahn: true}), 's u blisse strasse')
...
eql(normalize('Frauenhagen (bei Angermünde), Ziethenmühle Abzw.'), 'ziethenmuehle abzweig')
...
eql(normalize('U Friedrich-Wilhelm-Pl', {sbahnUbahn: true}), 'u friedrich wilhelm platz')
...
console.log('seems to be working ✔︎')
